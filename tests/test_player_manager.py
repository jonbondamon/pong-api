...
from tabletennis_api.models import APIResponse, PaginationInfo, Player
...
class TestPlayerManager:
    ...
    def test_list_success(self):
        ...
        mock_response = {
            "success": 1,
            "pager": {"page": 1, "per_page": 100, "total": 21094},
            "results": [
                {"id": "1168738", "name": "Jiri Karlik", "cc": None, "image_id": None},
                {
                    "id": "1166996",
    ...
    def test_list_with_country_filter(self):
        ...
        mock_response = {
            ...
            "results": [
                {"id": "1001", "name": "Jan Novak", "cc": "cz", "image_id": "12345"},
                {"id": "1002", "name": "Petr Svoboda", "cc": "cz", "image_id": None},
            ],
        }
    ...
    def test_list_with_pagination(self):
        ...
        mock_response = {
            ...
            "results": [
                {"id": "3001", "name": "Test Player", "cc": None, "image_id": None}
            ],
        }
...
class TestPlayerModel:
    ...
    def test_player_from_dict_basic(self):
        ...
        data = {"id": "1168738", "name": "Jiri Karlik", "cc": None, "image_id": None}
