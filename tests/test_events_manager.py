...
from tabletennis_api.models import EventSummary, Event, PaginationInfo, APIResponse
...
class TestEventsManager:
        ...
        mock_response = {
            ...
            "results": [
                ...
                },
                {
                    ...
                    "time_status": "3",
                    "league": {"id": "29097", "name": "TT Cup", "cc": "cz"},
                    "home": {"id": "682070", "name": "Zdenek Zahradka", "image_id": 0, "cc": None},
                    "away": {"id": "788338", "name": "Jakub Dvorak", "image_id": 0, "cc": None},
                    "ss": "3-0",
                    "scores": {},
                    "timeline": [],
                    "bet365_id": "178714423"
    ...
    def test_get_details_too_many_ids(self):
        ...
        with pytest.raises(ValueError, match="Maximum 10 event IDs allowed per request"):
    ...
    def test_search_success(self):
        ...
        result = self.events_manager.search(home="Jan Kocab", away="Jan Benak", time="20250729")
    ...
    def test_search_param_required_error(self):
        ...
        with pytest.raises(TableTennisAPIError, match="API error: PARAM_REQUIRED"):
            self.events_manager.search(home="Jan Kocab", away="Jan Benak", time="20250729")
    ...
    def test_search_invalid_page_error(self):
        ...
        with pytest.raises(ValueError, match="Page number must be >= 1"):
            self.events_manager.search(home="Jan Kocab", away="Jan Benak", time="20250729", page=0)
    ...
    def test_search_datetime_conversion(self):
        ...
        with pytest.raises(TableTennisAPIError):
            self.events_manager.search(home="Jan Kocab", away="Jan Benak", time=search_date)
    ...
    def test_search_string_date(self):
        ...
        with pytest.raises(TableTennisAPIError):
            self.events_manager.search(home="Jan Kocab", away="Jan Benak", time="20250115")
            ...
            "results": [
                {
                    ...
                    "home": {"id": "1001", "name": "Test Player", "image_id": 0, "cc": None},
                    "away": {"id": "1002", "name": "Another Player", "image_id": 0, "cc": None},
                    "ss": "3-2",
                    "scores": {},
                    "bet365_id": "178677300"
                }
...
class TestEventModel:
    ...
    def test_event_winner_detection(self):
        ...
        home_wins = Event(
            id="1", sport_id="92", time="123", time_status="3",
            league_id="1", league_name="Test", league_country_code=None,
            home_player=home_player, away_player=away_player,
            final_score="3-1", game_scores={}, timeline=[]
        )
        ...
        away_wins = Event(
            id="2", sport_id="92", time="123", time_status="3",
            league_id="1", league_name="Test", league_country_code=None,
            home_player=home_player, away_player=away_player,
            final_score="1-3", game_scores={}, timeline=[]
        )
        ...
        live_match = Event(
            id="3", sport_id="92", time="123", time_status="2",
            league_id="1", league_name="Test", league_country_code=None,
            home_player=home_player, away_player=away_player,
            final_score="2-1", game_scores={}, timeline=[]
        )
        ...
        scheduled_match = Event(
            id="4", sport_id="92", time="123", time_status="1",
            league_id="1", league_name="Test", league_country_code=None,
            home_player=home_player, away_player=away_player,
            final_score="0-0", game_scores={}, timeline=[]
        )
