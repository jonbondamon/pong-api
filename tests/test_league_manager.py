...
class TestLeagueManager:
    ...
    def test_list_all_leagues_single_page(self, api_client):
        ...
        single_page_response = {
            ...
            "results": [
                {"id": "1", "name": "League 1", "cc": None, "has_leaguetable": 1, "has_toplist": 0}
                for _ in range(50)
            ]
        }
    ...
    def test_list_all_leagues_multiple_pages(self, api_client):
        ...
        page1_response = {
            ...
            "results": [
                {"id": "1", "name": "League 1", "cc": None, "has_leaguetable": 1, "has_toplist": 0},
                {"id": "2", "name": "League 2", "cc": None, "has_leaguetable": 1, "has_toplist": 0}
            ]
        }
        ...
        page2_response = {
            ...
            "results": [
                {"id": "3", "name": "League 3", "cc": None, "has_leaguetable": 1, "has_toplist": 0},
                {"id": "4", "name": "League 4", "cc": None, "has_leaguetable": 1, "has_toplist": 0}
            ]
        }
        ...
        page3_response = {
            ...
            "results": [
                {"id": "5", "name": "League 5", "cc": None, "has_leaguetable": 1, "has_toplist": 0}
            ]
        }
        
        responses.add(responses.GET, "https://api.b365api.com/v1/league", json=page1_response, status=200)
        responses.add(responses.GET, "https://api.b365api.com/v1/league", json=page2_response, status=200)
        responses.add(responses.GET, "https://api.b365api.com/v1/league", json=page3_response, status=200)
